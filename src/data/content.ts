  ...
  pt: {
    ...
    projects: [
      ...
      },
      {
        ...
        description: "Jogo indie autoral de estratégia e simulação de taberna mágica onde o jogador gerencia recursos, fabrica poções complexas e controla batalhas táticas.",
        category: "gamedev",
        ...
        highlights: [
          ...
          "Jogo finalizado com sucesso e publicado comercialmente para a comunidade na plataforma Itch.io.",
        ],
  ...
  en: {
    ...
    projects: [
      ...
      },
      {
        id: "brew-and-battle",
        title: "Brew and Battle",
        description: "An original indie strategy and simulation game set in a magical tavern where the player manages resources, crafts complex potions, and controls tactical battles.",
        category: "gamedev",
        technologies: ["Unity", "C#", "UI Toolkit", "Scriptable Objects", "Game Design"],
        role: "Indie Game Developer",
        imageUrl: brewImg,
        highlights: [
          ...
          "Successfully finalized development cycle and commercially published the game to the community on the Itch.io platform.",
        ],
        liveUrl: "https://gabrielarcasa.itch.io/brew-and-battle",
      },
      {
